...
--  * tunic palette doesn't set when continuing a game
--  * make sure all items can be obtained properly
--  * change skeleton speed
--  * bug - simon stands up when ducking and attacking
...
--    end
    ...
    -- hearts count
    gfx.draw(x+28,y+28+8*4,gfx.cv2heart)
