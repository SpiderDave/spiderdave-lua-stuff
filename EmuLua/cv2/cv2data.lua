...
cv2.candles = {
    {x=0x1f0, y=0x10, area = {0x02,0x03,0x01}, },
    {x=0x80, y=0x90, area = {0x04,0x00,0x00,0x03}, },
    {x=0xb0, y=0x90, area = {0x04,0x00,0x00,0x03}, },
    {x=0x100, y=0x90, area = {0x04,0x00,0x00,0x03}, },
    {x=0x120, y=0x90, area = {0x04,0x00,0x00,0x03}, },
    {x=0x270, y=0x80, area = {0x04,0x00,0x00,0x03}, },
    {x=0x290, y=0x80, area = {0x04,0x00,0x00,0x03}, },
    {x=0x340, y=0xa0, area = {0x04,0x00,0x00,0x03}, },
    {x=0xe0, y=0xa0, area = {0x04,0x00,0x01,0x03}, },
    {x=0x70, y=0x90, area = {0x02,0x06,0x00,0x03}, },
    {x=0x90, y=0x90, area = {0x02,0x06,0x00,0x03}, },
    {x=0x200, y=0x60, area = {0x02,0x07,0x02,0x03}, },
    {x=0x1e0, y=0x60, area = {0x02,0x07,0x02,0x03}, },
    {x=0x390, y=0x90, area = {0x02,0x07,0x02,0x03}, },
    {x=0x350, y=0x90, area = {0x02,0x07,0x02,0x03}, },
    {x=0x20, y=0x170, area = {0x00,0x00,0x00,0x03}, },
    {x=0xa0, y=0x90, area = {0x00,0x00,0x00,0x03}, },
    {x=0x70, y=0x90, area = {0x00,0x00,0x00,0x03}, },
    {x=0x130, y=0x90, area = {0x00,0x00,0x00,0x03}, },
    {x=0x160, y=0x90, area = {0x00,0x00,0x00,0x03}, },
    {x=0x250, y=0x90, area = {0x00,0x00,0x00,0x03}, },
    {x=0x280, y=0x90, area = {0x00,0x00,0x00,0x03}, },
    {x=0x50, y=0x80, area = {0x02,0x03,0x01,0x00}, },
    {x=0x70, y=0x80, area = {0x02,0x03,0x01,0x00}, },
    {x=0x90, y=0x80, area = {0x02,0x03,0x01,0x00}, },
    {x=0x40, y=0x170, area = {0x00,0x00,0x00,0x00}, location="Jova", },
    {x=0x50, y=0x170, area = {0x00,0x00,0x00,0x00}, location="Jova", },
    {x=0x190, y=0x70, area = {0x02,0x03,0x01,0x00}, location="Dabis Path", },
    {x=0x180, y=0x90, area = {0x02,0x03,0x00,0x00}, location="Dabis Path", },
}
